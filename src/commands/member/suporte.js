...
export default {
  name: "suporte",
  description: "Suporte inteligente do PAULOZINXZ_BOT usando IA treinada",
  commands: ["suporte", "ajuda"],
  usage: `${PREFIX}suporte como instalar o PAULOZINXZ_BOT no Termux?
...
- Envie uma imagem com ${PREFIX}suporte para análise visual`,
    ...
    const messages = [
      {
        role: "system",
        content: `Você é um assistente especializado em suporte técnico do PAULOZINXZ_BOT.

Responda apenas assuntos relacionados a: tecnologia, programação, desenvolvimento de bots, inteligência artificial, 
machine learning ou assuntos relacionados ao PAULOZINXZ_BOT.
...
Quando receber imagens, analise o conteúdo visual primeiro e interprete-o considerando o contexto técnico do PAULOZINXZ_BOT.
